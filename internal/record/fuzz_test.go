...
func FuzzDecodeEdgePayload(f *testing.F) {
	valid, _ := EncodeEdgePayload(Edge{FromNode: "a", Relation: "links", ToNode: "b", CreatedAt: 1, UpdatedAt: 1})
	f.Add([]byte{})
...
func FuzzDecodeEdgeDeletePayload(f *testing.F) {
	valid, _ := EncodeEdgeDeletePayload(EdgeDelete{FromNode: "a", Relation: "links", ToNode: "b"})
	f.Add([]byte{})
